...
CREATE TABLE public.meditation_sessions (
  ...
  session_type TEXT NOT NULL DEFAULT 'timer', -- 'timer', 'guided', 'breathing'
  duration_minutes INTEGER NOT NULL,
  interval_minutes INTEGER,
  status TEXT NOT NULL DEFAULT 'started', -- 'started', 'paused', 'resumed', 'completed', 'abandoned'
...
CREATE TABLE public.sound_library (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  name TEXT NOT NULL,
  sound_type TEXT NOT NULL, -- 'start', 'interval', 'end', 'ambient'
  file_url TEXT NOT NULL,
  theme_pack TEXT, -- 'zen', 'nature', 'bells', etc.
  created_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
);
...
INSERT INTO public.sound_library (name, sound_type, file_url, theme_pack) VALUES
  ('Soft Bell', 'start', 'https://assets.mixkit.co/active_storage/sfx/2869/2869-preview.mp3', 'zen'),
  ('Gentle Chime', 'interval', 'https://assets.mixkit.co/active_storage/sfx/2568/2568-preview.mp3', 'zen'),
  ('Singing Bowl', 'end', 'https://assets.mixkit.co/active_storage/sfx/2870/2870-preview.mp3', 'zen');